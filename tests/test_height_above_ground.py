...
def test_hag_replace_z():
    """Test height above ground with replace Z option."""
...
def test_hag_heightaboveground_dim():
    """Test height above ground with using the HeightAboveGround dimension."""

    input_path = utils.test_data_filepath("stadium-utm.laz")
    output_path = utils.test_data_output_filepath("stadium-utm.copc.laz", "height_above_ground")
