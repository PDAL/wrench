...
@pytest.mark.skipif(pdal.info.major <= 2 and pdal.info.minor < 10, reason="Requires PDAL version 2.10 or higher")
def test_compare_without_sampling(autzen_2010_file: str, autzen_2023_file: str):
    """Test compare function"""

    output_path = utils.test_data_output_filepath(f"autzen-compare-no-sampling.copc.laz", "compare")
