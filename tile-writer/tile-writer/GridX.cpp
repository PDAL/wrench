...
void GridX::expand(const BOX3D& bounds, size_t points)
{
...
void GridX::resetLevel(int level)
{
...
VoxelKeyX GridX::key(double x, double y, double z) const
{
    ...
    return VoxelKeyX(xi, yi, zi, m_maxLevel);
}
